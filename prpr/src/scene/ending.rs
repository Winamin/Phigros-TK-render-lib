...
impl Scene for EndingScene {
    ...
    fn render(&mut self, tm: &mut TimeManager, ui: &mut Ui) -> Result<()> {
        ...
        draw_parallelogram(main, None, c2, true);
        {
            ...
            // NEW BEST + SCORE
            let r = draw_text_aligned(ui, &text, main.x + dx + 0.01 - 0.01, main.bottom() - 0.040, (0., 1.), 0.29, Color::new(1., 1., 1., pa));
            let r = draw_text_aligned(ui, &format!("{:07}", res.score), r.x - 0.012 + 0.01, r.y - 0.019, (0., 1.), 1.05, Color::new(1., 1., 1., pa));
