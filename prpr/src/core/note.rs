...
impl Note {
    pub fn rotation(&self, line: &JudgeLine) -> f64 {
    ...
    pub fn update(&mut self, res: &mut Resource, parent_rot: f64, parent_tr: &Matrix, ctrl_obj: &mut CtrlObject, line_height: f64) {
    ...
    pub fn now_transform(&self, res: &Resource, ctrl_obj: &CtrlObject, base: f64, incline_sin: f64) -> Matrix {
